...
<body>
    ...
    >
      ...
      <p
        class="font-sans text-4xl font-bold text-black max-w-5xl lg:text-7xl lg:pr-24 md:text-6xl"
      >
      ...
      <div class="grid gap-4 md:grid-cols-3">
        <div
          class="flex-col p-8 py-16 rounded-lg shadow-2xl md:p-12 bg-gradient-to-br from-gray-100 to-white"
        >
          <p
            class="flex items-center justify-center text-4xl font-semibold text-white bg-green-800 rounded-full shadow-lg w-14 h-14"
          >
            1
          </p>
          <div class="h-6"></div>
          <p class="font-serif text-3xl">We write assignments with piece of mind</p>
        </div>
        <div
          class="flex-col p-8 py-16 rounded-lg shadow-2xl md:p-12 bg-gradient-to-b from-gray-100 to-white"
        >
          <p
        ...
        <div
          class="flex-col p-8 py-16 rounded-lg shadow-2xl md:p-12 bg-gradient-to-bl from-gray-100 to-white"
        >
          <p
