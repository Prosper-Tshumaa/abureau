...
<head>
	...
	<title>Homework and Assignment Help Online | Assessments Bureau</title>
	<!-- Tailwind -->
...
<body class="antialiased">
	...
	<div class="container px-4 lg:px-8 mx-auto max-w-screen-xl text-gray-700 overflow-x-hidden">
		...
		<div data-aos="flip-up" class="max-w-xl mx-auto text-center mt-24">
			<h1 class="font-bold text-darken my-3 text-2xl">All-In-One <span class="text-indigo-500">Research and Study Portal.</span></h1>
			<p class="leading-relaxed text-gray-500">Assessments Bureau is one powerful online suite that combines all the tools needed to run a successful school or office.</p>
		</div>
		<!-- card -->
		<div class="grid md:grid-cols-3 gap-14 md:gap-5 mt-20">
			<div data-aos="fade-up" class="bg-white shadow-xl p-6 text-center rounded-xl">
				...
				<p class="px-4 text-gray-500">Simple and secure control of your financial and legal transactions. Send customized invoices and contracts</p>
			</div>
			<div data-aos="fade-up" data-aos-delay="150" class="bg-white shadow-xl p-6 text-center rounded-xl">
				...
				<p class="px-4 text-gray-500">Schedule and reserve classrooms on Discord.We Keep detailed records of student attendance</p>
			</div>
			<div data-aos="fade-up" data-aos-delay="300" class="bg-white shadow-xl p-6 text-center rounded-xl">
				...
				<p class="px-4 text-gray-500">Automate and track emails to individuals or groups. Assessments Bureau built-in system helps organize your work </p>
			</div>
		</div>
		...
		<div class="mt-28">
			<div data-aos="flip-down" class="text-center max-w-screen-md mx-auto">
				<h1 class="text-3xl font-bold mb-4">What is<span class="text-indigo-500">Assessments Bureau?</span></h1>
				<p class="text-gray-500">Assessment Bureau is a platform that allows Students to seek assistance online classes whereby they can store the course materials online; manage assignments, quizzes and exams; monitor due dates; grade results and get feedback all in one place.</p>
			</div>
            <div data-aos="fade-up" class="flex flex-col md:flex-row justify-center space-y-5 md:space-y-0 md:space-x-6 lg:space-x-10 mt-7">
				<div class="relative md:w-5/12">
					<img class="rounded-2xl" src="/images/Rectangle 19.png" alt="">
					<div class="absolute bg-black bg-opacity-20 bottom-0 left-0 right-0 w-full h-full rounded-2xl">
						<div class="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2">
							<h1 class="uppercase text-white font-bold text-center text-sm lg:text-xl mb-3">FUN</h1>
						</div>
					</div>
				</div>
				<div class="relative md:w-5/12">
					<img class="rounded-2xl" src="/images/Rectangle 21.png" alt="">
					<div class="absolute bg-black bg-opacity-20 bottom-0 left-0 right-0 w-full h-full rounded-2xl">
						<div class="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2">
							<h1 class="uppercase text-white font-bold text-center text-sm lg:text-xl mb-3">FOR STUDENTS</h1>
                            <a href="/pages/subjects">
							<button class="rounded-full text-white text-xs lg:text-md px-6 py-3 w-full font-medium focus:outline-none transform transition hover:scale-110 duration-300 ease-in-out" style="background: rgba(35, 189, 238, 0.9)">See More </button>
                            </a>
						</div>
					</div>
				</div>
		...
		<div class="sm:flex items-center sm:space-x-8 mt-36">
			<div data-aos="fade-right" class="sm:w-1/2 relative">
				...
				<h1 class="font-semibold text-2xl relative z-50 text-darken lg:pr-10">Everything you can do in a physical classroom, <span class="text-indigo-500">you can do with Assessment Bureau</span></h1>
				<p class="py-5 lg:pr-32">Assessments Bureau school management software helps traditional and online schools manage scheduling, attendance, payments and virtual classrooms all in one secure cloud-based system.</p>
				<a href="/pages/about" class="underline">Learn More</a>
			</div>
			<div data-aos="fade-left" class="sm:w-1/2 relative mt-10 sm:mt-0">
				...
				<img class="rounded-xl z-40 relative" src="/images/teacher-explaining.png" alt="">
		...
		<div class="md:flex mt-40 md:space-x-10 items-start">
			<div data-aos="fade-down" class="md:w-7/12 relative">
				...
				<img class="relative z-50 floating" src="/images/vcall.png" alt="">
			...
			<div data-aos="fade-down" class="md:w-5/12 mt-20 md:mt-0 text-gray-500">
				<h1 class="text-2xl font-semibold text-darken lg:pr-40">A <span class="text-indigo-500">user interface</span> designed for the classroom</h1>
		...
		<div class="flex flex-col md:flex-row items-center md:space-x-10 mt-16">
			<div data-aos="fade-right" class="md:w-1/2 lg:pl-14">
				<h1 class="text-darken font-semibold text-3xl lg:pr-56"><span class="text-indigo-500">Tools</span> For Teachers And Learners</h1>
			...
			<img data-aos="fade-left" class="md:w-1/2" src="/images/girl-with-books.png">
		</div>

		<!-- Assessments, Quizzes, Tests -->
		<div class="mt-20 flex flex-col-reverse md:flex-row items-center md:space-x-10">
			<div data-aos="fade-right" class="md:w-6/12">
				<img class="md:w-11/12" src="/images/true-false.png">
			</div>
			<div data-aos="fade-left" class="md:w-6/12 md:transform md:-translate-y-20">
				<h1 class="font-semibold text-darken text-3xl lg:pr-64">Assessments, <span class="text-indigo-500">Quizzes</span>, Tests</h1>
		...
		<div class="flex flex-col md:flex-row items-center mt-12">
			<div data-aos="fade-right" class="md:w-5/12">
				<h1 class="text-darken font-semibold text-3xl leading-tight lg:pr-32"><span class="text-indigo-500">Class Management</span> Tools for Educators</h1>
			...
			<img data-aos="fade-left" class="md:w-7/12" src="/images/gradebook.png">
		</div>

		<!-- One-on-One Discussions -->
		<div class="mt-24 flex flex-col-reverse md:flex-row items-center md:space-x-10">
			<div data-aos="fade-right" class="md:w-7/12">
				<img class="md:w-11/12" src="/images/discussion.png">
			</div>
			<div data-aos="fade-left" class="md:w-5/12 md:transform md:-translate-y-6">
				<h1 class="font-semibold text-darken text-3xl lg:pr-64">One-on-One <span class="text-indigo-500">Discussions</span></h1>
				<p class="text-gray-500 my-5 lg:pr-24">Teachers and teacher assistants can talk with students privately without leaving the Discord environment.</p>
			</div>
		</div>
		...
		<div class="mt-24 flex flex-col md:flex-row items-start md:space-x-10">
			<div data-aos="zoom-in-right" class="md:w-6/12">
				<img class="md:w-8/12 mx-auto" src="/images/integrations.png">
			</div>
			<div data-aos="zoom-in-left" class="md:w-6/12">
				...
				<h1 class="font-semibold text-darken text-2xl lg:pr-40">Many educational tools and platform <span class="text-indigo-500">integrations</span></h1>
				<p class="text-gray-500 my-5 lg:pr-20">Schoology has every tool your classroom needs and comes pre-integrated with more tools, student information systems (SIS), and education platforms.</p>
				<button class="px-5 py-3 border border-indigo-500 text-indigo-500 font-medium my-4 focus:outline-none transform transition hover:scale-110 duration-300 ease-in-out rounded-full">See All Integrations</button>
			</div>
		</div>
		...
		<div class="mt-24 flex flex-col-reverse md:flex-row items-start md:space-x-10">
			<div data-aos="zoom-in-right" class="md:w-5/12">
				...
				<p class="text-gray-500 my-5 lg:pr-36">Assessments Bureau has got a lot of positive ratings from our users around the world.</p>
				<p class="text-gray-500 my-5 lg:pr-36">Some of the students and teachers were greatly helped by the Assessment Bureau.</p>
			</div>
			<div data-aos="zoom-in-left" class="md:w-7/12">
				<img class="md:w-10/12 mx-auto" src="/images/testimonials.png">
			</div>
		</div>
	</div>
	<!-- AOS init -->
